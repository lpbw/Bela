...
$numext=$_POST['numext'];
 		  ...
 		  $consulta = "insert into proveedores(nombres,ap_paterno,ap_materno,empresa,direccion,num_ext,telefono,codigo_barras,id_alta_usuarios,fecha) values('$nombre','$appaterno','$apmaterno','$empresa','$dir','$numext','$tel','$codigo','$usuario',now())";
...
<div class="container"><!--contenedor-->
   ...
   <div class="row">
	...
	<h4 align="center" class="center white-text">Nuevo Proveedor</h4>
	
	<!--campo nombre y direccion-->
      <div class="row">
        <div class="input-field col s4">
		  <i class="fa fa-user prefix white-text"></i>
          <input id="nombres" type="text"  name="nombres" class="validate white-text" required>
          <label for="nombre" class="white-text">Nombres</label>
        </div>
		
		<div class="input-field col s4">
          <input id="appaterno" type="text" name="appaterno"  class="validate white-text" required>
          <label for="appaterno" class="white-text">Apellido Paterno</label>
        </div>
		       	  <!--inicio ap_materno-->
      <div class="input-field col s4">
          <input id="apmaterno" type="text" name="apmaterno"  class="validate white-text" required>
	  ...
	  <div class="row">
	    	  ...
	    	  <!--inicio empresa-->
	      <div class="input-field col s4">
          <input id="empresa" type="text" name="empresa"  class="validate white-text" required>
	   ...
	   <!--fin campo empresa-->
		 ...
		 <div class="input-field col s4">
          <input id="codigobarras" type="text" name="codigobarras" class="validate white-text" required>
